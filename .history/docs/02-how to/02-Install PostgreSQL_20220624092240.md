...
In order to proceed with first application we will start with the RedwoodJS Tutorial at [this pargraph](https://redwoodjs.com/docs/tutorial/intermission#using-the-example-repo-recommended).
___
___
