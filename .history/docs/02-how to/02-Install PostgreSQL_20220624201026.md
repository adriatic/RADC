...
Observe that this database's owner is "postgres" - this info will be used later in In order to save this database see the screenshot below:
...
The definition of the "DATABASE_URL" enviroment variable should be
