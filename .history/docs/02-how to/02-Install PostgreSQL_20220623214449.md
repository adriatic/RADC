...
- installation / deployment of the [Example Repo](https://redwoodjs.com/docs/tutorial/intermission#using-the-example-repo-recommended) using PostgreSQL database
