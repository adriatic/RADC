...
In order to verify the PostgresQL correct installation we will use two RedwoodJS known applications

1. [Example Repo](https://redwoodjs.com/docs/tutorial/intermission#using-the-example-repo-recommended) and

2. [Example store stripe](https://github.com/redwoodjs/example-store-stripe) and modify them to use using PostgreSQL database
