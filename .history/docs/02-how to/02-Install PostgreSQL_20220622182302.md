...
If you installed PostgreSQL using Brew and have problems with this installarin, the best start is to uninstall PostgreSQL using Brew using the information i the article [Completely uninstalling a Homebrew installation of Postgres](https://blog.testdouble.com/posts/2021-01-28-how-to-completely-uninstall-homebrew-postgres/#completely-uninstalling-a-homebrew-installation-of-postgres)
